...
| - Mastery and critical verbal understanding of OO and design patterns beyond course content<br>- Research‑level conceptual insight | - AI beyond MiniMax (more efficient/dynamic algorithm)<br>- Exceptional work, presentation and report<br>- Outstanding individual contributions | **87%** |
| - Exceptional verbal command of OO theory and advanced design patterns<br>- Deep, articulate insights into architecture and design | - Outstanding extensions and advanced methods<br>- Publishable‑quality product<br>- Outstanding report and presentation<br>- Exceptional individual contributions | **100%** |
